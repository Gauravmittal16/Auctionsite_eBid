...
<div id="pricing" class="container-fluid">
  <div class="text-center">
    ...
    <h4>Choose a type of login between user and Dealers</h4>
  </div>
  <div class="row slideanim">
    <div class="col-sm-4 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-body">
          <p><strong>Account</strong> is able to participate in auction</p>
    ...
    <div class="col-sm-4 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-body">
          <p><strong>Add </strong> Products</p>
          <p><strong>Delete </strong>Products</p>
          <p><strong>Arrange </strong>Auctions</p>
    ...
    <div class="col-sm-4 col-xs-12">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-body">
          <p><strong>Handle Auctions</strong></p>
          <p><strong>Manage Client's Data</strong>  </p>
          <p><strong>Organise Special Events</strong> </p>
          <p><strong>Provides Services Dealers</strong> Sit</p>
          <p><strong>Endless</strong> Amet</p>
        </div>
        <div class="panel-footer">
          <h3>$49</h3>
          <h4>per month</h4>
          <button class="btn btn-lg" data-toggle='modal' data-target='#loginadmin'>Log In</button>
        </div>
      </div>      
    </div>    
  </div>
